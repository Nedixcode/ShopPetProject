...
export default function Filters({ onFilter }) {
    const [openCategory, setOpenCategory] = useState("Тип товара"); // можно null
    ...
    return (
        <aside className="filtersSidebar" aria-label="Фильтры и сортировка">
            <div className="filtersHeader">
                <div className="filtersHeaderTitle">
                    <div className="filtersHeaderKicker">Каталог</div>
                    <h2 className="filtersH2">Фильтры</h2>
                </div>
